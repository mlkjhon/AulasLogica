...
while (true) {
    let continuar = prompt('Deseja fechar o programa? S/N: ')
    if (continuar == 'S') {
        break;
    }
    ...
    if (tenho_ingresso == 'sim' && entrada == 'sim') {
        tipoDoIngresso1 = prompt('Qual o tipo do seu ingresso? (VIP ou basico) ');
    }



    if (tipoDoIngresso1 == 'basico') {
        verificação_basica1 = prompt('Oque voce quer fazer? (reservar ingresso ou verificar reserva) ');
    if (verificação_basica2 == 'verificar' || reserva_basica == 'verificar ingresso'){
        reserva_basica = Number(prompt('Qual sua cadeira?'))
    }
    
    if (tipoDoIngresso1 == 'basico') {
        verificação_basica1 = prompt('Oque voce quer fazer? (reservar ingresso ou verificar reserva) ');
    if (verificação_basica2 == 'reservar' || reserva_basica == 'verificar reserva'){
        reserva_basica = Number(prompt('Qual sua cadeira?'))
    }
    }

    if (tipoDoIngresso1 == 'VIP') {
        verificação_vip1 = prompt('Oque voce quer fazer? (reservar ingresso ou verificar reserva) ');
        if (verificação_vip1 == 'verificar' || reserva_VIP == 'verificar ingresso'){
            reserva_VIP = Number(prompt('Qual sua cadeira?'))
        }
    }

    if ((reserva_basica == 'reservar' || reserva_basica == 'verificar reserva') && reserva_basica == 'VIP' ) {
        verificação_basica1 = Number(prompt('Qual a cadeira'))
        if (verificação_vip1 ) {
            reserva_vip = prompt('Qual a sua cadeira')
        }
    }
